...
export default async function page({params}) {
  ...
  async function getdetails() {
    let response = await fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=664ad047271160036661d41b18ad9034&language=en-US`)
    response= await response.json()
    return response
  }
  async function getactors() {
    let response = await fetch(`https://api.themoviedb.org/3/movie/${id}/credits?api_key=664ad047271160036661d41b18ad9034&language=en-US`)
    response= await response.json()
